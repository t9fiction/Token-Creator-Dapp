...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/helpers/getPasskeyProviderFromUserAgent.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "getPasskeyProviderFromUserAgent": (()=>getPasskeyProviderFromUserAgent)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$shared$2f$utils$2f$functions$2f$detectBrowser$2f$detectBrowser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/shared/utils/functions/detectBrowser/detectBrowser.js [app-ssr] (ecmascript)");
...
const getPasskeyProviderFromUserAgent = (userAgent)=>{
    ...
    const browser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$shared$2f$utils$2f$functions$2f$detectBrowser$2f$detectBrowser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectBrowserName"])(userAgent);
    return browser;
};
;
}}),
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/helpers/getTimeSince.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getTimeSince = (date)=>{
    const { t } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$locale$2f$locale$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Locale"].getInstance();
    ...
    if (timeDifference >= month) {
        ...
        return {
            unit: monthsAgo === 1 ? t('dyn_time_since.month') : t('dyn_time_since.months'),
            value: monthsAgo
        };
    }
    ...
    if (timeDifference >= minute) {
        ...
        return {
            unit: minutesAgo === 1 ? t('dyn_time_since.minute') : t('dyn_time_since.minutes'),
            value: minutesAgo
        };
    }
    const secondsAgo = Math.floor(timeDifference / 1000);
    return {
        unit: secondsAgo === 1 ? t('dyn_time_since.second') : t('dyn_time_since.seconds'),
        value: secondsAgo
    };
};
;
}}),
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/helpers/helpers.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_esm__({
    ...
    "getExportKeysOption": (()=>getExportKeysOption),
...
/** Applies Math.floor, but takes into account edge cases, like how 2.99999 should be 3 */ // First apply ceil with very high accuracy, to account for floating point inaccuracies
// const smartFloor = (value: number) => Math.floor(value);
const smartFloor = (value)=>Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$utils$2f$src$2f$ceil$2f$ceil$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceil"])(value, 13));
...
const roundBalance = (balanceString, decimals = 4)=>{
    ...
    if (clearedBalance > MAX_BALANCE_VALUE) {
        ...
        const roundedBalance = Math.floor(dividedValue / MAX_BALANCE_VALUE * PRECISION_FLOOR_DIVIDER) / PRECISION_FLOOR_DIVIDER;
    ...
    if (clearedBalance < minBalanceValue && clearedBalance > 0) return `< ${minBalanceValue}`;
    const roundedBalance = smartFloor(clearedBalance * decimalsPrecision) / decimalsPrecision;
    if (roundedBalance === 0) return '0.0';
    return String(roundedBalance);
};
const capitalize = (text)=>text.charAt(0).toUpperCase() + text.slice(1);
const getExportKeysOption = (connector, providerSettings)=>{
    var _a;
    if (!connector || !(providerSettings === null || providerSettings === void 0 ? void 0 : providerSettings.length) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$connector$2d$core$2f$src$2f$utils$2f$isMagicConnector$2f$isMagicConnector$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMagicConnector"])(connector)) {
        return;
    }
    const keyExportUrl = (_a = providerSettings.find((provider)=>provider.provider === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$api$2d$core$2f$src$2f$models$2f$ProviderEnum$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProviderEnum"].MagicLink)) === null || _a === void 0 ? void 0 : _a.keyExportUrl;
    if (!keyExportUrl) {
        return;
    }
    return ()=>{
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/context/DynamicWidgetContext.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "DynamicWidgetContext": (()=>DynamicWidgetContext),
    "DynamicWidgetContextProvider": (()=>DynamicWidgetContextProvider),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$widgets$2f$DynamicWidget$2f$hooks$2f$useViewController$2f$useViewController$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useViewController/useViewController.js [app-ssr] (ecmascript)");
...
;
;
const DynamicWidgetContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
const DynamicWidgetContextProvider = ({ children })=>{
    ...
    const availableWalletsContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const { setShowDynamicUserProfile, showDynamicUserProfile, multiWallet } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$context$2f$DynamicContext$2f$useDynamicContext$2f$useInternalDynamicContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useInternalDynamicContext"])();
    ...
    const { view: dynamicWidgetView, setView, goToInitialView: goToInitialDynamicWidgetView } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$widgets$2f$DynamicWidget$2f$hooks$2f$useViewController$2f$useViewController$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useViewController"])(isKYCEnabled && !multiWallet ? 'profile' : 'wallets');
    const [viewProps, setViewProps] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const setDynamicWidgetView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((view, props)=>{
        setView(view);
        setViewProps(props || {});
    }, [
        setView
    ...
    const goToProfileView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (isKYCEnabled) return setDynamicWidgetView('profile');
        setDynamicWidgetView('wallets');
    }, [
        isKYCEnabled,
        multiWallet
    ]);
    const overridenWidgetView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (dynamicWidgetView === 'manage-passkeys' || dynamicWidgetView === 'manage-mfa') return 'settings';
        if (!isKYCEnabled && !multiWallet && dynamicWidgetView !== 'settings' && dynamicWidgetView !== 'profile') return 'wallets';
        if (dynamicWidgetView === 'edit-profile') return 'profile';
        if (dynamicWidgetView === 'global-wallet') return 'wallets';
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$events$2f$useDynamicEvents$2f$useDynamicEvents$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useInternalDynamicEvents"])('logout', ()=>goToInitialDynamicWidgetView());
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(DynamicWidgetContext.Provider, {
        value: value,
        children: children
    });
};
const useWidgetContext = ()=>{
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(DynamicWidgetContext);
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/context/DynamicWidgetContext.types.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "DynamicGlobalWalletViews": (()=>DynamicGlobalWalletViews),
    "DynamicMfaWidgetViews": (()=>DynamicMfaWidgetViews),
    "DynamicPasskeyWidgetViews": (()=>DynamicPasskeyWidgetViews),
    "DynamicSettingsViews": (()=>DynamicSettingsViews),
    "DynamicTransactionsWidgetViews": (()=>DynamicTransactionsWidgetViews)
});
'use client';
const DynamicSettingsViews = [
    'settings'
];
...
const DynamicPasskeyWidgetViews = [
    'manage-passkeys'
];
const DynamicMfaWidgetViews = [
    'manage-mfa'
];
const DynamicTransactionsWidgetViews = [
    'send-balance'
];
;
}}),
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/DynamicWidget.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DynamicWidget = ({ buttonContainerClassName = '', buttonClassName = '', innerButtonComponent, variant = 'modal' })=>{
    const { showAuthFlow, setShowDynamicUserProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$context$2f$DynamicContext$2f$useDynamicContext$2f$useInternalDynamicContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useInternalDynamicContext"])();
    const { widgetRef, inlineControlsRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$widgets$2f$DynamicWidget$2f$context$2f$DynamicWidgetContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWidgetContext"])();
    ...
    const showDynamicConnectButton = !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$useIsLoggedIn$2f$useIsLoggedIn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIsLoggedIn"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$components$2f$ShadowDOM$2f$ShadowDOM$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ShadowDOM"], {
        ...
        id: 'dynamic-widget',
        children: showDynamicConnectButton ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$components$2f$DynamicConnectButton$2f$DynamicConnectButton$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DynamicConnectButton"], {
            buttonContainerClassName: buttonContainerClassName,
            buttonClassName: buttonClassName,
            copykey: 'dyn_widget.connect',
            children: innerButtonComponent
            ...
            children: [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$widgets$2f$DynamicWidget$2f$components$2f$DynamicNav$2f$DynamicNav$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DynamicNav"], {}),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$widgets$2f$DynamicWidget$2f$components$2f$DynamicUserProfile$2f$DynamicUserProfile$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DynamicUserProfile"], {
                    variant: variant
                })
            ]
        })
...
//# sourceMappingURL=node_modules_%40dynamic-labs_sdk-react-core_src_lib_widgets_DynamicWidget_40ac5d._.js.map