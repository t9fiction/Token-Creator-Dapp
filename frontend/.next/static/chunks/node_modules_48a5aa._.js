(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_48a5aa._.js", {
...
"[project]/node_modules/valtio/esm/vanilla.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/proxy-compare/dist/index.modern.js [app-client] (ecmascript)");
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_resolve_absolute_path__("node_modules/valtio/esm/vanilla.mjs")}`;
    }
};
;
...
const buildProxyFunction = (objectIs = Object.is, newProxy = (target, handler)=>new Proxy(target, handler), canProxy = (x)=>isObject(x) && !refSet.has(x) && (Array.isArray(x) || !(Symbol.iterator in x)) && !(x instanceof WeakMap) && !(x instanceof WeakSet) && !(x instanceof Error) && !(x instanceof Number) && !(x instanceof Date) && !(x instanceof String) && !(x instanceof RegExp) && !(x instanceof ArrayBuffer), defaultHandlePromise = (promise)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markToTrack"])(snap, true);
    ...
    Reflect.ownKeys(target).forEach((key)=>{
        ...
        if (refSet.has(value)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markToTrack"])(value, false);
    ...
    const handler = {
        ...
        set (target, prop, value, receiver) {
            ...
            removePropListener(prop);
            if (isObject(value)) {
                value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUntracked"])(value) || value;
            }
            let nextValue = value;
...
"[project]/node_modules/@walletconnect/modal-core/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const state$7 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    history: [
        "ConnectWallet"
    ],
    view: "ConnectWallet",
...
const RouterCtrl = {
    state: state$7,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$7, ()=>callback(state$7));
    },
    push (view, data) {
...
const CoreUtil = {
    ...
    formatUniversalUrl (appUrl, wcUri, name) {
        ...
        if (safeAppUrl.startsWith("https://t.me")) {
            const formattedUri = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(wcUri).toString("base64").replace(/[=]/g, "");
            if (safeAppUrl.endsWith("/")) {
...
const state$6 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    enabled: isEnabled,
    userSessionId: "",
    events: [],
...
const EventsCtrl = {
    state: state$6,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$6.events, ()=>callback((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["snapshot"])(state$6.events[state$6.events.length - 1])));
    },
    initialize () {
...
const state$5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    chains: void 0,
...
const OptionsCtrl = {
    state: state$5,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$5, ()=>callback(state$5));
    },
    setChains (chains) {
...
const state$4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    projectId: "",
...
const ConfigCtrl = {
    state: state$4,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$4, ()=>callback(state$4));
    },
    setConfig (config) {
        var _a, _b;
...
const state$3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    wallets: {
        listings: [],
        total: 0,
        page: 1
...
const state$2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    open: false
});
const ModalCtrl = {
    state: state$2,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$2, ()=>callback(state$2));
    },
    async open (options) {
        return new Promise((resolve)=>{
...
const state$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["proxy"])({
    themeMode: isDarkMode() ? "dark" : "light"
});
const ThemeCtrl = {
    state: state$1,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribe"])(state$1, ()=>callback(state$1));
    },
...
"[project]/node_modules/@walletconnect/modal/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class WalletConnectModal {
    constructor(config){
        this.openModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModalCtrl"].open;
        this.closeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModalCtrl"].close;
        this.subscribeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModalCtrl"].subscribe;
        this.setTheme = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig(config);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConfigCtrl"].setConfig(config);
        this.initUi();
    }
    async initUi() {
        if (typeof window !== "undefined") {
            await __turbopack_require__("[project]/node_modules/@walletconnect/modal-ui/dist/index.js [app-client] (ecmascript, async loader)")(__turbopack_import__);
            const modal = document.createElement("wcm-modal");
            document.body.insertAdjacentElement("beforeend", modal);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OptionsCtrl"].setIsUiLoaded(true);
        }
    }
}
;
...
//# sourceMappingURL=node_modules_48a5aa._.js.map