(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/dd92d_modules_@dynamic-labs_sdk-react-core_src_lib_widgets_DynamicWidget_hooks_432d65._.js", {

"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useFetchCurrency/useFetchCurrency.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useFetchCurrency = (connector, network)=>{
    const fetchChainCurrency = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$_virtual$2f$_tslib$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__awaiter"])(void 0, void 0, void 0, function*() {
            var _a, _b, _c, _d;
            if (!connector) return null;
            const chainId = yield connector.getNetwork();
            const chainInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$connector$2d$core$2f$src$2f$utils$2f$getChainInfo$2f$getChainInfo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChainInfoWithOverrides"])((_a = connector.connectedChain) !== null && _a !== void 0 ? _a : '');
    ...
    const { data: currency, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$usePromise$2f$usePromise$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePromise"])(fetchChainCurrency, {
        deps: [
            network
        ]
    });
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useFetchChain/useFetchChain.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useFetchChain = (connector)=>{
    const fetchChain = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$_virtual$2f$_tslib$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__awaiter"])(void 0, void 0, void 0, function*() {
            var _a, _b;
            if (!connector) return {
                chainId: undefined,
                name: '',
            ...
            const chainInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$connector$2d$core$2f$src$2f$utils$2f$getChainInfo$2f$getChainInfo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChainInfoWithOverrides"])(connectedChain || '');
            const chainWithIcon = {
                chainId,
    ...
    const { data: chain, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$usePromise$2f$usePromise$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePromise"])(fetchChain, {
        deps: [
            connector
        ]
    });
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useViewController/useViewController.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useViewController = (initialView)=>{
    const [_view, setView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useFetchNameService/useFetchNameService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useFetchNameService = (address)=>{
    ...
    const { data: nameService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$usePromise$2f$usePromise$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePromise"])({
        "useFetchNameService.usePromise": ()=>getNameService(address)
    }["useFetchNameService.usePromise"], {
        deps: [
            address,
            network,
            getNameService
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useFetchBalance/useFetchBalance.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useFetchBalance = ({ wallet, chain, network })=>{
    const [balance, setBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('0.0');
    const isFetchBalanceDisabled = !chain || wallet.connector.supportsNetworkSwitching() && !network;
    const fetchBalance = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$_virtual$2f$_tslib$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__awaiter"])(void 0, void 0, void 0, function*() {
            if (isFetchBalanceDisabled) return;
            const value = yield wallet.getBalance();
            setBalance(value);
        });
    const { isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$hooks$2f$usePromise$2f$usePromise$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePromise"])(fetchBalance, {
        deps: [
            wallet.address,
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useWalletDownloadLinks/useWalletDownloadLinks.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$book$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/wallet-book/src/index.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$functions$2f$parseWalletLinks$2f$parseWalletLinks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/utils/functions/parseWalletLinks/parseWalletLinks.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$shared$2f$utils$2f$functions$2f$getBrowserIcon$2f$getBrowserIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/shared/utils/functions/getBrowserIcon/getBrowserIcon.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$book$2f$src$2f$helpers$2f$getWalletLinks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@dynamic-labs/wallet-book/src/helpers/getWalletLinks.js [app-client] (ecmascript)");
'use client';
;
;
;
const useWalletDownloadLinks = (walletConnector)=>{
    ...
    const walletLinks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$wallet$2d$book$2f$src$2f$helpers$2f$getWalletLinks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWalletLinks"])(walletBook, walletConnector.key);
    const { currentDesktopUrl, userBrowser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$utils$2f$functions$2f$parseWalletLinks$2f$parseWalletLinks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseWalletLinks"])(walletLinks);
    if (userBrowser && currentDesktopUrl) {
        return [
            {
                Icon: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$shared$2f$utils$2f$functions$2f$getBrowserIcon$2f$getBrowserIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrowserIcon"])(userBrowser),
                key: userBrowser,
    ...
    return Object.entries(walletLinks).filter(([, link])=>link !== '').filter(([name])=>name !== 'ios' && name !== 'android').map(([name, link])=>({
            Icon: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dynamic$2d$labs$2f$sdk$2d$react$2d$core$2f$src$2f$lib$2f$shared$2f$utils$2f$functions$2f$getBrowserIcon$2f$getBrowserIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrowserIcon"])(name),
            key: name,
            link: link,
            name: name
        }));
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useMultiWalletPromptState/useMultiWalletPromptState.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@dynamic-labs/sdk-react-core/src/lib/widgets/DynamicWidget/hooks/useCloseMultiWalletPrompt/useCloseMultiWalletPrompt.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=dd92d_modules_%40dynamic-labs_sdk-react-core_src_lib_widgets_DynamicWidget_hooks_432d65._.js.map